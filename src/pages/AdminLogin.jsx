...
const AdminLogin = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center content-center pt-72'>
      ...
      <button onClick={validateValues} className="text-white bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
    </div>
  )
}
